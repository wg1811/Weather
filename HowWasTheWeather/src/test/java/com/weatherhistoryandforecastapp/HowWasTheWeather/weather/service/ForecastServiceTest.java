...
public class ForecastServiceTest {
   ...
   Predicate<HttpStatusCode> isError = status -> status.is4xxClientError() || status.is5xxServerError();
        Function<ClientResponse, Mono<? extends Throwable>> errorHandler = response ->
            Mono.error(new ResponseStatusException(HttpStatus.NOT_FOUND, "No weather data found for the given coordinates."));
        ...
        StepVerifier.create(result)
            .expectErrorMatches(throwable ->
                ...
                "No weather data found for the given coordinates.".equals(throwable.getMessage()))
            .verify();
    }
    ...
    private ForecastData createMockForecastData() {
        ...
        HourlyForecastData hourly = new HourlyForecastData(
            ...
            new double[]{20.0, 21.0}, new double[]{22.0, 23.0}, new int[]{10, 20}, new double[]{0.0, 0.1},
            new double[]{0.0, 0.0}, new double[]{0.0, 0.0}, new double[]{0.0, 0.0}, new double[]{0.0, 0.0},
            new int[]{0, 1}, new double[]{1013.0, 1012.0}, new double[]{1010.0, 1009.0}, new int[]{50, 60},
            new double[]{24000.0, 23000.0}, new double[]{10.0, 12.0}, new int[]{180, 190}, new double[]{5.0, 5.5},
            new int[]{1, 1}, new int[]{3600, 3600});
        DailyForecastData daily = new DailyForecastData(
            new String[]{now}, new int[]{0}, new double[]{25.0}, new double[]{15.0}, new double[]{27.0}, new double[]{17.0},
            new String[]{"2025-04-02T06:00Z"}, new String[]{"2025-04-02T18:00Z"}, new double[]{43200.0},
            new double[]{36000.0}, new double[]{6.0}, new double[]{7.0}, new double[]{0.0}, new double[]{0.0},
            new double[]{0.0}, new double[]{0.0}, new double[]{0.0}, new int[]{10}, new double[]{15.0},
            new double[]{20.0}, new int[]{180});

        // Minimal units - not used in DTO mapping but required for ForecastData
        CurrentWeatherUnits currentUnits = new CurrentWeatherUnits("iso8601", "seconds", "°C", "%", "°C", "", "mm", "mm", "mm", "cm", "WMO code", "%", "km/h", "degrees", "km/h");
        HourlyForecastUnits hourlyUnits = new HourlyForecastUnits("iso8601", "°C", "°C", "%", "mm", "mm", "mm", "cm", "cm", "WMO code", "hPa", "hPa", "%", "m", "km/h", "degrees", "", "", "seconds");
        DailyForecastUnits dailyUnits = new DailyForecastUnits("iso8601", "WMO code", "°C", "°C", "°C", "°C", "iso8601", "iso8601", "seconds", "seconds", "", "", "mm", "mm", "mm", "cm", "hours", "%", "km/h", "km/h", "degrees");
