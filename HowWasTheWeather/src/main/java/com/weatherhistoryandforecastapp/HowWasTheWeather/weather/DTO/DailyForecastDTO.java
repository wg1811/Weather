...
public record DailyForecastDTO(
        ...
        public DailyForecastDTO(LocalDateTime[] time, int[] weather_code, double[] temperature_2m_max,
                        double[] temperature_2m_min, double[] apparent_temperature_max,
                        double[] apparent_temperature_min, LocalDateTime[] sunrise, LocalDateTime[] sunset,
